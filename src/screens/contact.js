...
const Contact = () => {
    ...
    return (
        <>
            <footer id="contact" className={`px-4 ${styles.footer}`}>
                <Row className="d-flex align-items-center justify-content-center px-4">
                        ...
                        <Col xs={12} sm={12} md={7} lg={5} className={`d-flex flex-column ${styles["contact-responsive"]}`}>
                        ...
                        <Col xs={12} sm={12} md={5} lg={5} className={`d-flex flex-column ${styles["contact-responsive"]}`}>
                            <div className='d-inline align-items-center justify-content-center'>
