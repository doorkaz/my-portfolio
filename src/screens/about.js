    ...
    return (
        <>
            <section id="about" className={`mt-5 ${styles.aboutme}`}>
                ...
                <p>Soy responsable, riguroso, altamente motivado, con gran capacidad de resolución y adaptabilidad. Me encanta embarcarme en nuevos desafíos, en el viaje interminable que es la programación!</p>
