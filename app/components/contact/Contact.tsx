...
export const Contact = (): JSX.Element => {
  return (
    <footer id='contact' className='border-t border-neutral-750 mt-8'>
      <Container className='flex flex-row xs:flex-col sm:flex-row w-full py-8 lg:py-16 gap-4'>
        <H2 className='flex justify-center sm:justify-start items-center text-center w-full sm:w-4/12 lg:6/12'>Contáctame.</H2>

        <div className='flex justify-end xs:justify-center sm:justify-evenly lg:justify-around items-start w-full sm:w-8/12 lg:w-6/12 xs:gap-10'>
          <SocialMediaItem
